  ...
  return (
    <div className="flex min-h-screen flex-col bg-black">
      ...
      <main className="flex-1">
        {/* ================= HERO ================= */}
        <section className="relative min-h-[60vh] overflow-hidden bg-gradient-to-b from-black via-slate-900 to-black px-6 py-16 md:px-12 md:py-24">
          <motion.div
            initial="hidden"
            animate="visible"
        ...
        <section className="bg-black px-6 py-16 md:px-12">
          <div className="mx-auto max-w-7xl grid gap-8 md:grid-cols-4 text-center">
            {stats?.map((stat, i) => (
              <motion.div
                key={i}
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {teamMembers?.map((member, index) => (
                <motion.div
                  ...
                  className="overflow-hidden rounded-xl border border-slate-800 bg-slate-800"
                >
                  {/* Image */}
                  <div className="relative h-72 bg-slate-700">
                    {member?.imageUrl ? (
                      <Image
                        src={member.imageUrl}
